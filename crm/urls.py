...
urlpatterns = [
    ...
    path('interns/<uuid:pk>/', views.intern_profile_detail, name='intern_profile_detail'),
    path('interns/<uuid:pk>/edit/', views.intern_profile_edit, name='intern_profile_edit'),
]
